...
import 'noo_canvasform_page.dart';
import 'noo_canvasedit_page.dart';
...
class NooCanvasPage extends StatefulWidget {
  ...
  @override
  State<NooCanvasPage> createState() => LayerOrder();
}

class LayerOrder extends State<NooCanvasPage> {
  ...
  Future<void> calculateLimitKredit() async {
    try {
      getLimitKredit = await clk.getAllLimitKreditTransaction(
          widget.lgn.fdKodeNoo!, widget.startDayDate);
      listOrder = await codr.getDataOrderByKodeLangganan(widget.lgn.fdKodeNoo!);
      if (getLimitKredit.isEmpty) {
        gtpesananBaru = listOrder.first.fdTotalOrder;
        sisaLK = getLimitKredit.first.fdSisaLimit ?? 0;
        limitKredit = getLimitKredit.first.fdLimitKredit;
        ...
        sumpengajuanBaru = (getLimitKredit.first.fdPengajuanLimitBaru);
      ...
      if (gtpengajuanBaru > 0) {
        ...
        await clk.deleteLimitKreditBatch(widget.lgn.fdKodeNoo!);
      }
    } catch (e) {
      setState(() {
        isLoading = false;
  ...
  Future<void> initLoadPage() async {
    ...
    try {
      ...
      _listOrder =
          await codr.getAllOrderCanvasByKodeLangganan(widget.lgn.fdKodeNoo!);
                ...
                try {
                  ...
                  await db.transaction((txn) async {
                    ...
                    _listOrder = await codr
                        .getAllOrderByKodeLangganan(widget.lgn.fdKodeNoo!);
                  });
                                ...
                                ? Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        settings: const RouteSettings(
                                            name: 'NooCanvasForm'),
                                        builder: (context) => NooCanvasFormPage(
                                                    ...
                                                    MaterialPageRoute(
                                                        settings:
                                                            const RouteSettings(
                                                                name:
                                                                    'NooCanvasEditPage'),
                                                        builder: (context) => NooCanvasEditPage(
                                                            fdNoEntryOrder:
                                                                _listOrder[
                                                                        index]
                                                                    .fdNoEntryOrder
                                                          ...
                                                          isExistTTB
                                                              ...
                                                              : setState(() {
                                                                  isLoadTTB =
                                                                      true;
                                                                  ttbImgName =
                                                                      '${param.appDir}/${param.imgPath}/${param.ttbImgName(1, widget.user.fdKodeSF, widget.lgn.fdKodeNoo!, _listOrder[index].fdNoEntryOrder.toString(), widget.startDayDate)}';
                                                                });
                                                          print(
                                                              widget.routeName);
                  ...
                  ? FloatingActionButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                settings:
                                    const RouteSettings(name: 'NooCanvasForm'),
                                builder: (context) => NooCanvasFormPage(
                                    fdNoEntryOrder: '',
                                    lgn: widget.lgn,
                                    user: widget.user,
