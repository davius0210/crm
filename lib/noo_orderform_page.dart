...
import 'noo_ordercartform_page.dart';
...
class NooOrderFormPage extends StatefulWidget {
  ...
  @override
  State<NooOrderFormPage> createState() => LayerNooOrderForm();
}

class LayerNooOrderForm extends State<NooOrderFormPage> {
  ...
  void initLoadPage() async {
    try {
      ...
      listBarang =
          await cbrg.getAllBarangNoo(fdKodeHarga, widget.user.fdKodeSF);
      setState(() {
        isLoading = false;
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.user.fdTipeSF == '1' ? 'Penjualan' : 'Pesanan'),
      ),
      body: Form(
          key: formInputKey,
          child:
