...
class OrderSummaryForm extends StatefulWidget {
  ...
  @override
  State<OrderSummaryForm> createState() => LayerOrderFormPage();
}

class LayerOrderFormPage extends State<OrderSummaryForm> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: isLoading
          ...
          : BottomAppBar(
              ...
              child: TextButton(
                onPressed: () async {
                  if (alamatSelected == null || alamatSelected!.isEmpty) {
                  ...
                  if (formInputKey.currentState!.validate()) {
                    grandTotal = widget.totalPesanan -
                        ...
                        totalPromosiExtra +
                        orderExist;
                    print('widget.totalPesanan: ${widget.totalPesanan}');
