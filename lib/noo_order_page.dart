...
class NooOrderPage extends StatefulWidget {
  ...
  @override
  State<NooOrderPage> createState() => LayerOrder();
}

class LayerOrder extends State<NooOrderPage> {
  ...
  Future<void> initLoadPage() async {
    ...
    try {
      ...
      _listOrder = await codr.getAllOrderByKodeLangganan(widget.lgn.fdKodeNoo!);
                  ...
                  ? FloatingActionButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                settings:
                                    const RouteSettings(name: 'NooOrderForm'),
                                builder: (context) => NooOrderFormPage(
                                    fdNoEntryOrder: '',
                                    lgn: widget.lgn,
                                    user: widget.user,
