...
class NooOrderEditPage extends StatefulWidget {
  ...
  @override
  State<NooOrderEditPage> createState() => LayerNooOrderEdit();
}

class LayerNooOrderEdit extends State<NooOrderEditPage> {
  ...
  Future<void> initLoadPage() async {
    try {
      ...
      final lbarang =
          await cbrg.getAllBarangNoo(lkodeHarga, widget.user.fdKodeSF);
